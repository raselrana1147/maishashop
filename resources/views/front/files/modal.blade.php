                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="modal-bg">
                                    ...
                                    <div class="offer-content"> <img src="{{ asset('assets/frontend/assets/images/Offer-banner.png')}}"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xs-12">
                            <div class="quick-view-img"><img src="{{ asset('assets/frontend/assets/images/pro3/1.jpg')}}" alt=""
            ...
            <div class="setting_box_body">
                ...
                <div class="setting-body">
                    <div class="setting-title">
                        <div>
                            <img src="{{ asset('assets/frontend/assets/images/icon/logo.png')}}" class="img-fluid" alt="">
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="gradient.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/gradient.jpg')}}"
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="index.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/fashion.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-2.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/fashion-2.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-3.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/fashion-3.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-4.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/fashion-4.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-5.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/fashion-5.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-6.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/fashion-6.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-7.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/fashion-7.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="furniture.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/furniture.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="furniture-2.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/furniture-2.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="furniture-3.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/furniture-dark.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="electronic-1.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/electronics.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="electronic-2.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/electronics-2.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="electronic-3.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/electronics-3.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="marketplace-demo.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/marketplace.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="marketplace-demo-2.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/marketplace-2.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="marketplace-demo-3.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/marketplace-3.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="marketplace-demo-4.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/marketplace-4.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="vegetables.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/vegetables.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="vegetables-2.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/vegetables-2.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="vegetables-3.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/vegetables-3.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="jewellery.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/jewellery.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="jewellery-2.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/jewellery-2.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="jewellery-3.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/jewellery-3.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="bags.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/bag.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="watch.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/watch.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="medical.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/medical.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="perfume.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/perfume.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="yoga.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/yoga.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="christmas.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/christmas.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="bicycle.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/bicycle.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="marijuana.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/marijuana.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="gym-product.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/gym.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="tools.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/tools.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="shoes.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/shoes.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="books.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/books.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="kids.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/kids.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="game.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/game.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="beauty.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/beauty.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="left_sidebar-demo.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/left-sidebar.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="video-slider.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/video-slider.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="metro.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/metro.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="goggles.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/goggles.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="flower.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/flower.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="light.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/light.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="nursery.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/nursery.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="pets.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/pets.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="video.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/video.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="lookbook-demo.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/lookbook.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="full-page.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/full-page.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="instagram-shop.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/instagram.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="parallax.html" class="layout-container">
                                        <img src="{{ asset('assets/frontend/assets/images/landing-page/demo/parallax.jpg')}}"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="modal-bg">
                                    ...
                                    <div class="media">
                                        <img src="{{ asset('assets/frontend/assets/images/stop.png')}}"
